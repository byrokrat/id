...
class SIETest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    function testUnbalancedVerification()
    {
        $sie = new SIE();
     ...
     */
    function testAccountingYearError()
    {
        $sie = new SIE();
    ...
    function testGenerate()
    {
		...
		$expected .= "#KONTO \"1920\" \"Bank\"\r\n#KTYP \"1920\" \"T\"\r\n#KONTO \"3000\" \"Income\"\r\n#KTYP \"3000\" \"I\"\r\n";
		$expected .= "\r\n#VER \"\" \"\" $date \"testver\"\r\n{\r\n";
        $expected .= "\t#TRANS 1920 {} 100.00\r\n";
        $expected .= "\t#TRANS 3000 {} -100.00\r\n";
		$expected .= "}\r\n";
		$expected = iconv("UTF-8", "CP437", $expected);
    ...
    function testImportChart()
    {
        $siestr = "#FILTYP KONTO\r\n#PROGRAM \"itbz_STB_SIE\" \"1.0\"\r\n#TEXT \"FOOBAR\"\r\n#FORMAT PC8\r\n#GEN 20120430 \"itbz_STB_SIE\"\r\n#KPTYP \"BAS2010\"\r\n\r\n";
		$siestr .= "#KONTO \"1920\" \"Bank\"\r\n#KTYP \"1920\" \"T\"\r\n#KONTO \"3000\" \"Income\"\r\n#KTYP \"3000\" \"I\"\r\n";
     ...
     */
    function testImportChartInvalidChartType()
    {
        $siestr = "#FILTYP KONTO\r\n#KPTYP";
		$siestr = iconv("UTF-8", "CP437", $siestr);
        $sie = new SIE();
    ...
    function invalidSieAccountStringProvider()
    {
        return array(
            array("#KONTO \"1920\"\r\n#KTYP \"1920\" \"T\""),
     ...
     */
    function testImportChartInvalidAccount($account)
    {
        $siestr = "#FILTYP KONTO\r\n#KPTYP \"BAS2010\"\r\n";
        $siestr .= $account;
		$siestr = iconv("UTF-8", "CP437", $siestr);
